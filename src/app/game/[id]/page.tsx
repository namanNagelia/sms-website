...
const defaultGameData: GameProp = {
  ...
  gameLink:
    "https://skilltech-v2-public.s3.us-west-1.amazonaws.com/videos/B648BD33-CB18-4D55-900E-BB86A1D70E12-512-00000016D78691A6.mp4",
};
  ...
  const PointCard = ({
    ...
    return (
      <div className="flex flex-col justify-center font-dinCondensed text-lg">
        <div
          className={`rounded-full bg-${color} w-8 h-8 items-center flex justify-center text-2xl text-brandWhite`}
        >
          {number}
        </div>
        {type}
    ...
    <header className="sticky top-24 h-20 w-full z-50 flex-row justify-between px-10 text-brandWhite font-dinCondensed">
      <div className="flex flex-row h-fit">
        ...
        <div className="flex flex-col justify-center items-start mx-4">
          ...
          <text>
            {leftTeam.record.wins} - {leftTeam.record.losses}
          </text>
        </div>
      </div>
